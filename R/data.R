...
#'  \item{blastula 128-cell}{The expression value at the blastula 128-cell stage.}
...
#'  \item{gastrula 50%-epiboly}{The expression value at the gastrula 50%-epiboly stage.}
#'  \item{gastrula shield}{The expression value at the gastrula shield stage.}
#'  \item{gastrula 75%-epiboly}{The expression value at the gastrula 75%-epiboly stage.}
#'  \item{segmentation 1-4 somites}{The expression value at the segmentation 1-4 somites stage.}
#'  \item{segmentation 14-19 somites}{The expression value at the segmentation 14-19 somites stage.}
#'  \item{segmentation 20-25 somites}{The expression value at the segmentation 20-25 somites stage.}
#'  \item{pharyngula prim-5}{The expression value at the pharyngula prim-5 stage.}
#'  \item{pharyngula prim-15}{The expression value at the pharyngula prim-15 stage.}
#'  \item{pharyngula prim-25}{The expression value at the pharyngula prim-25 stage.}
#'  \item{hatching long-pec}{The expression value at the hatching long-pec stage.}
#'  \item{larval protruding mouth}{The expression value at the larval protruding mouth stage.}
